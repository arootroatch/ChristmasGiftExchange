...
describe('dragDrop', () => {
  ...
  describe('drop', () => {
    ...
    it('updates state when dropping name into house', () => {
      ...
      const houseContainer = document.querySelector(`#house-0 .${cardStyles.nameContainer}`);
    ...
    it('updates state when moving name between houses', () => {
      ...
      const nameWrapper = document.querySelector('#wrapper-Alex');
      const house0Container = document.querySelector(`#house-0 .${cardStyles.nameContainer}`);
      const house1Container = document.querySelector(`#house-1 .${cardStyles.nameContainer}`);
      ...
      shouldSelect(`#house-1 .${cardStyles.nameContainer} #wrapper-Alex`);
    });
